...
// Send newSong data to db then reload DOM with updated song data. this is when you get the id back from the database and you need to do something with it
...
// Build a song obj from form data. this is a method that I am calling.
